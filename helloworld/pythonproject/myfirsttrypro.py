...
class RealTimeEmotionDetector:
    ...
    def __init__(self, classifier_model: NO_FACE_LABEL):
...
def run_real_time_emotion_detector(
    ...
    from utils.image_classifier import NO_FACE_LABEL
    ...
    classifier = NO_FACE_LABEL(csv_path=dataset_csv, algorithm=classifier_algorithm, land_marker=land_marker)
